 ...
 *
 * Last modified 2017-03-09 02:55:37
 *
...
public class GetProjectReplyEvent extends BaseEvent<ProjectReply> {
     ...
     * @param uuid 唯一识别码
     */
    public GetProjectReplyEvent(@Nullable String uuid) {
        super(uuid);
    }
     ...
     */
    public GetProjectReplyEvent(@Nullable String uuid, @NonNull Integer code, @Nullable ProjectReply projectReply) {
