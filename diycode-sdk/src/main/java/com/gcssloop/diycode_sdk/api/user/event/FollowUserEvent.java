 ...
 *
 * Last modified 2017-03-09 00:50:03
 *
...
public class FollowUserEvent extends BaseEvent<State> {
     ...
     * @param uuid 唯一识别码
     */
    public FollowUserEvent(@Nullable String uuid) {
        super(uuid);
    }
     ...
     * @param state 实体数据
     */
    public FollowUserEvent(@Nullable String uuid, @NonNull Integer code, @Nullable State state) {
