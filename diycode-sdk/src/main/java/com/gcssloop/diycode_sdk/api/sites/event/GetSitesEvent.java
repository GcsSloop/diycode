 ...
 *
 * Last modified 2017-03-09 00:35:08
 *
...
public class GetSitesEvent extends BaseEvent<List<Sites>> {
     ...
     * @param uuid 唯一识别码
     */
    public GetSitesEvent(@Nullable String uuid) {
        super(uuid);
    }
     ...
     * @param sites 实体数据
     */
    public GetSitesEvent(@Nullable String uuid, @NonNull Integer code, @Nullable List<Sites> sites) {
